...
class EtherScanIoApi(object):
    """
    Base bscscan.com Api implementation
    """

    def __init__(self, baseurl=None, proxies={}):
        baseurl = baseurl or "https://bscscan.com/"
...
if __name__=="__main__":
    ...
    output_directory = "../contracts/%s/"%("bsc" if prefix=="www" else prefix)
    overwrite = False
    amount = 1000000

    e = EtherScanIoApi(baseurl="https://%s.bscscan.com"%(prefix))
